...
/**
 * Клас, парсиращ и управляващ заявките на потребителя.
...
public class Query {
    ...
    /**
     * Метод, обработващ заявката на потребителя.
     * @param userRequest Заявката на потребителя.
     */
    ...
    /**
     * Метод, филтриращ специалните свойства на всеки един човек
     * (Майка - Деца, Пенсионер - Пенсия, Работник - Заплата.)
     * @param userRequest Заявката на потребителя.
     */
